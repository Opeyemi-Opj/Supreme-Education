...
import Image1 from '../../assets/images/image88.png'
import Image2 from '../../assets/images/export.png';
import { Link } from 'react-router-dom'; // ✅ Correct Import
import Arrowlft from '../../assets/images/arrow-left.png'
import  bg1  from '../../assets/images/image89.png';
import  bg2  from '../../assets/images/image18.png';
...
<p className='w-[200px] bg-[#DD3333] rounded-md font-raleway text-[#FFFFFF] text-[18px] font-medium leading-[21.13px] px-5 py-3 transition duration-300  '> News & Events </p>

<Link to="/gallery" className="text-[#292D32] text-[16px] sm:text-[16px] font-medium border-b-2 border-transparent hover:text-[#DD3333] hover:border-[#DD3333] transition-all duration-300">
Gallery
</Link>
